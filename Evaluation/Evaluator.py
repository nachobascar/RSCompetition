...
class EvaluatorNegativeItemSample(Evaluator):
    ...
    def __init__(
        ...
        self.URM_items_to_rank = sps.csr_matrix(
            self.URM_test.copy().astype(bool)
        ) + sps.csr_matrix(URM_test_negative.copy().astype(bool))
    ...
    def _run_evaluation_on_selected_users(
        ...
        for test_user in users_to_evaluate:
            ...
            recommended_items, all_items_predicted_ratings = (
                recommender_object.recommend(
